...
static void isAnsweringMachine(struct ast_channel *chan, const char *data)
{
	...
	ast_verb(3, "AMD: initialSilence [%d] greeting [%d] afterGreetingSilence [%d] "
		"totalAnalysisTime [%d] minimumWordLength [%d] betweenWordsSilence [%d] maximumNumberOfWords [%d] silenceThreshold [%d] maximumWordLength [%d] detectamd [%d] detectfax [%d] detectbeep [%d] \n",
				initialSilence, greeting, afterGreetingSilence, totalAnalysisTime,
				minimumWordLength, betweenWordsSilence, maximumNumberOfWords, silenceThreshold, maximumWordLength, detectamd, detectfax, detectbeep);
		...
		if (detectfax || detectbeep) {
			...
			if (f2->frametype == AST_FRAME_DTMF) {
				if (f2->subclass.integer == 0) {
					ast_verb(3, "AMD: Channel [%s]. FAX\n", chan->name);
					strcpy(amdStatus , "FAX");
					ast_frfree(f2);
					res = 1;
					break;
				} else if (f2->subclass.integer > 0 && f2->subclass.integer < 5) {
					ast_verb(3, "AMD: Channel [%s]. BEEP%d\n", chan->name, f2->subclass.integer);
...
static int load_config(int reload)
{
	...
	ast_verb(3, "AMD defaults: initialSilence [%d] greeting [%d] afterGreetingSilence [%d] "
		...
		//ADDED: 2015-08-04
		"faxToneFreq [%d] faxToneDuration [%d] faxToneDB [%d] beep1ToneFreq [%d] beep1ToneDuration [%d] beep1ToneDB [%d] beep2ToneFreq [%d] beep2ToneDuration [%d] "
		"beep2ToneDB [%d] beep3ToneFreq [%d] beep3ToneDuration [%d] beep3ToneDB [%d] beep4ToneFreq [%d] beep4ToneDuration [%d] beep4ToneDB [%d]\n",
		//ADDED: 2015-08-04
		...
		//ADDED: 2015-08-04
		dfltFaxToneFreq, dfltFaxToneDuration, dfltFaxToneDB, dfltBeep1ToneFreq, dfltBeep1ToneDuration, dfltBeep1ToneDB, dfltBeep2ToneFreq, dfltBeep2ToneDuration,
		dfltBeep2ToneDB, dfltBeep3ToneFreq, dfltBeep3ToneDuration, dfltBeep3ToneDB, dfltBeep4ToneFreq, dfltBeep4ToneDuration, dfltBeep4ToneDB);
		//ADDED: 2015-08-04
