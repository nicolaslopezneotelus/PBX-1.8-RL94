	...
	char *exitcontext)
{
	...
	//DELETED: 2016-07-28
	//ADDED: 2016-07-28
	if (ast_check_hangup(chan) || ast_check_hangup(spyee_autochan->chan) || ast_test_flag(spyee_autochan->chan, AST_FLAG_ZOMBIE)) {
		return 0;
	}
	//ADDED: 2016-07-28
