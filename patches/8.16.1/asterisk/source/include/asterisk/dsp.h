...
//ADDED: 2015-08-04
#define DSP_FEATURE_TONE_DETECT		(1 << 5)
//ADDED: 2015-08-04
...
#define DSP_FEATURE_CALL_PROGRESS	(DSP_PROGRESS_TALK | DSP_PROGRESS_RINGING | DSP_PROGRESS_BUSY | DSP_PROGRESS_CONGESTION | DSP_PROGRESS_EARLY_MEDIA)
#define DSP_FEATURE_WAITDIALTONE	(1 << 20)		/*!< Enable dial tone detection */
//ADDED: 2015-08-04
#define DSP_PROGRESS_EARLY_MEDIA	(1 << 21)		/*!< Enable early media detection */
//ADDED: 2015-08-04
