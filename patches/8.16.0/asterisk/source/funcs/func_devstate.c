...
/*** DOCUMENTATION
	...
	//ADDED: 2014-06-03
	<manager name="GetDeviceState" language="en_US">
		<synopsis>
		...
		<description>
			<para>The GetDeviceState command can be used to get device state information.</para>
			<para>Possible DeviceState return values are:</para>
...
//ADDED: 2014-06-03
static int manager_getdevicestate(struct mansession *s, const struct message *m)
{
	...
	astman_append(
		...
		"State: %d\r\n"
		"\r\n",
		device, ast_device_state(device));
	return 0;	
}
//ADDED: 2014-06-03
...
static int unload_module(void)
{
	...
	//ADDED: 2014-06-03
	res |= ast_manager_unregister("GetDeviceState");
	//ADDED: 2014-06-03
	return res;
}
...
static int load_module(void)
{
	...
	//ADDED: 2014-06-03
	res |= ast_manager_register_xml("GetDeviceState", 0, manager_getdevicestate);
	//ADDED: 2014-06-03
	return res;
}
